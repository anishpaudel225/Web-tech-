...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Username   = 'anishpaudel582@gmail.com';             // Your Gmail address
        $mail->Password   = 'ctlj febd qqoq izpx';               // Use app password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;           // Enable implicit TLS encryption
        $mail->Port       = 465;                                    // TCP port

        // Recipients
        $mail->setFrom($email, $name);
        $mail->addAddress('sandyanish25@gmail.com', 'Receiver');
